...
public class SynchronizedTabulatedFunctionTest {
    ...
    public void testSetY() {
        ...
        assertEquals(checkFunction.getY(0), 2, ACCURACY);
        checkFunction.setY(1, 3);
        assertEquals(checkFunction.getY(1), 3, ACCURACY);
        checkFunction.setY(2, 7);
        assertEquals(checkFunction.getY(2), 7, ACCURACY);
    }
    ...
    public void testApply() {
        assertEquals(getSynchronizedList().apply(5), 7, ACCURACY);
        assertEquals(getSynchronizedList().apply(7), 9, ACCURACY);
        assertEquals(getSynchronizedList().apply(9), 11, ACCURACY);
        assertEquals(getSynchronizedArray().apply(6), 8, ACCURACY);
