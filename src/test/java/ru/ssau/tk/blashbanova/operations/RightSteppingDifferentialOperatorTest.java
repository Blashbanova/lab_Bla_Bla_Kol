...
public class RightSteppingDifferentialOperatorTest {
    ...
    public void testDerive() {
        ...
        assertEquals(differentialOperator.derive(sqr).apply(1), 2.001, ACCURACY);
        assertEquals(differentialOperator.derive(sqr).apply(2), 4.001, ACCURACY);
        assertEquals(differentialOperator.derive(sqr).apply(3), 6.001, ACCURACY);
    }
}
